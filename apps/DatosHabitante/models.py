...
class Habitante(models.Model):
    ...
    id_nacionalidad = models.ForeignKey(
        'Nacionalidad', models.DO_NOTHING, db_column='id_nacionalidad')
    id_pais_origen = models.ForeignKey(
        'PaisOrigen', models.DO_NOTHING, db_column='id_pais_origen', blank=True, null=True)
...
class HabitanteDiscapacidad(models.Model):
    # The composite primary key (id_habitante, id_tipo_discapacidad) found, that is not supported. The first column is selected.
    id_habitante = models.OneToOneField(
        Habitante, models.DO_NOTHING, db_column='id_habitante', primary_key=True)
    id_tipo_discapacidad = models.ForeignKey(
        'TipoDiscapacidad', models.DO_NOTHING, db_column='id_tipo_discapacidad')
...
class HabitanteEstadoCivil(models.Model):
    # The composite primary key (id_habitante, id_estado_civil) found, that is not supported. The first column is selected.
    id_habitante = models.OneToOneField(
        Habitante, models.DO_NOTHING, db_column='id_habitante', primary_key=True)
    id_estado_civil = models.ForeignKey(
        EstadoCivil, models.DO_NOTHING, db_column='id_estado_civil')
...
class HabitanteEtnia(models.Model):
    # The composite primary key (id_habitante, id_etnia) found, that is not supported. The first column is selected.
    id_habitante = models.OneToOneField(
        Habitante, models.DO_NOTHING, db_column='id_habitante', primary_key=True)
    id_etnia = models.ForeignKey(
        Etnia, models.DO_NOTHING, db_column='id_etnia')
...
class HabitanteNivelEstudio(models.Model):
    # The composite primary key (id_habitante, id_nivel_estudio) found, that is not supported. The first column is selected.
    id_habitante = models.OneToOneField(
        Habitante, models.DO_NOTHING, db_column='id_habitante', primary_key=True)
    id_nivel_estudio = models.ForeignKey(
        'NivelEstudio', models.DO_NOTHING, db_column='id_nivel_estudio')
...
class HabitanteTipoSangre(models.Model):
    # The composite primary key (id_habitante, id_tipo_sangre) found, that is not supported. The first column is selected.
    id_habitante = models.OneToOneField(
        Habitante, models.DO_NOTHING, db_column='id_habitante', primary_key=True)
    id_tipo_sangre = models.ForeignKey(
        'TipoSangre', models.DO_NOTHING, db_column='id_tipo_sangre')
