...
class Comuna(models.Model):
    ...
    id_ambito_territorial = models.ForeignKey(
        AmbitoTerritorial, models.DO_NOTHING, db_column='id_ambito_territorial')
...
class ConsejoComunal(models.Model):
    ...
    id_comuna = models.ForeignKey(
        Comuna, models.DO_NOTHING, db_column='id_comuna')
