...
class Vivienda(models.Model):
    ...
    id_ubicacion = models.ForeignKey(
        Ubicacion, models.DO_NOTHING, db_column='id_ubicacion')
    ...
    id_consejo_comunal = models.ForeignKey(
        ConsejoComunal, models.DO_NOTHING, db_column='id_consejo_comunal')
    id_tipo_vivienda = models.ForeignKey(
        TipoVivienda, models.DO_NOTHING, db_column='id_tipo_vivienda')
    id_tipo_techo = models.ForeignKey(
        TipoTecho, models.DO_NOTHING, db_column='id_tipo_techo')
    id_tipo_pared = models.ForeignKey(
        TipoPared, models.DO_NOTHING, db_column='id_tipo_pared')
    id_tipo_piso = models.ForeignKey(
        TipoPiso, models.DO_NOTHING, db_column='id_tipo_piso')
    id_situacion_vivienda = models.ForeignKey(
        SituacionVivienda, models.DO_NOTHING, db_column='id_situacion_vivienda')
    id_tipo_ocupacion_vivienda = models.ForeignKey(
        TipoOcupacionVivienda, models.DO_NOTHING, db_column='id_tipo_ocupacion_vivienda')
